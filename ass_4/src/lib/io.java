...
public class io {
	...
	public static void printInteger(int arg0) {
		System.out.println(arg0);
	}

	public static void printFloat(float arg0) {
		System.out.println(arg0);
	}

	public static void printBoolean(boolean arg0) {
		System.out.println(arg0);
	}

	public static void printString(String arg0) {
		System.out.println(arg0);
	}
	...
	public static int readInteger() {
		int tmp = 0;
        try {
            tmp = int_of_string(input.readLine());
            return tmp;
        } catch (IOException e) {
        	e.printStackTrace();
        }
	...
	public static float readFloat() {
		float tmp = 0f;
        try {
            tmp = float_of_string(input.readLine());
            return tmp;
        } catch (IOException e) {
        	e.printStackTrace();
        }
	...
	public static boolean readBoolean() {
		boolean tmp = true;
        try {
            tmp = bool_of_string(input.readLine());
            return tmp;
        } catch (IOException e) {
        	e.printStackTrace();
        }
