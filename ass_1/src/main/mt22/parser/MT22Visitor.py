...
class MT22Visitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MT22Parser#indexedArrayLiteral.
    def visitIndexedArrayLiteral(self, ctx:MT22Parser.IndexedArrayLiteralContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MT22Parser#allType.
    def visitAllType(self, ctx:MT22Parser.AllTypeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MT22Parser#nonVoidType.
    def visitNonVoidType(self, ctx:MT22Parser.NonVoidTypeContext):
        return self.visitChildren(ctx)
